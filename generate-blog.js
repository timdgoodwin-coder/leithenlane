  ...
  <article class="blog-post" id="blog-post">
    ...
    <div class="blog-post__body">
      <div class="container container--narrow">
        ...
        <div class="blog-post__quiz-cta" id="quiz-cta">
          <div class="blog-post__quiz-cta-inner">
            <div class="blog-post__quiz-cta-badge">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
              Free Assessment
            </div>
            <h3 class="blog-post__quiz-cta-title">How healthy are your e-commerce operations?</h3>
            <p class="blog-post__quiz-cta-text">Take the free 3-minute quiz to score your operations across fulfillment, inventory, CX, tech, and finance. Find out where the gaps are before they cost you.</p>
            <a href="/quiz.html" class="btn btn--primary">
              Take the Health Score Quiz
        ...
        <div class="blog-post__cta">
          <div class="blog-post__cta-inner">
            ...
            <p>${post.cta}</p>
            <a href="${post.ctaLink || '/#contact'}" class="btn btn--primary">${post.ctaLabel || 'Book a Free Consultation'}</a>
          </div>
        </div>
      </div>
    </div>
